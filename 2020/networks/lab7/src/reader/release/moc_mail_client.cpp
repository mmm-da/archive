/****************************************************************************
** Meta object code from reading C++ file 'mail_client.h'
**
...
#error "The header file 'mail_client.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 15), // "loginButtonPush"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16), // "updateButtonPush"
QT_MOC_LITERAL(4, 45, 13), // "delButtonPush"
QT_MOC_LITERAL(5, 59, 15), // "listItemClicked"
QT_MOC_LITERAL(6, 75, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(7, 92, 4) // "item"

    },
    "MailClient\0loginButtonPush\0\0"
    "updateButtonPush\0delButtonPush\0"
...
void MailClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MailClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginButtonPush(); break;
        case 1: _t->updateButtonPush(); break;
        case 2: _t->delButtonPush(); break;
...
QT_INIT_METAOBJECT const QMetaObject MailClient::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_MailClient.data,
    qt_meta_data_MailClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
