...
org 0030h
start:
    mov IE, #10001100b ; разрешаем прерывания. включаем прерывание по таймеру 1 и по источнику внешних прерываний 1.
    mov IP, #00000100b ; приоритет прерываний за клавиотурой
    mov r5, #0h
