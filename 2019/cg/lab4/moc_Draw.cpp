/****************************************************************************
** Meta object code from reading C++ file 'Draw.hpp'
**
...
#error "The header file 'Draw.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 10), // "reGenModel"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 1), // "n"
QT_MOC_LITERAL(4, 23, 16), // "selectProjection"
QT_MOC_LITERAL(5, 40, 5) // "index"

    },
    "DrawArea\0reGenModel\0\0n\0selectProjection\0"
    "index"
};
...
void DrawArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->reGenModel((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->selectProjection((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
