...
class GLWidget(QGLWidget):
    ...
    def initializeGL(self):
        ...
        sp = [1.0, 1.0, 1.0, 1.0]
        self.light1Diffuse = [0.8, 0.9, 0.9]
        self.light2Diffuse = [0,9, 0.8, 0.8]
        light1Position = [map_len_x+1,map_len_y/2,map_len_z+10, 1.0]
        light2Position = [map_len_x+1,map_len_y/2,-map_len_z-10, 1.0]
